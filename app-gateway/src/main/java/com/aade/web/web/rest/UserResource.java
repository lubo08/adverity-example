package com.aade.web.web.rest;

import com.aade.web.config.Constants;
import com.aade.web.domain.DayData;
import com.aade.web.domain.Row;
import com.aade.web.domain.User;
import com.aade.web.repository.UserRepository;
import com.aade.web.repository.search.RowSearchRepository;
import com.aade.web.repository.search.UserSearchRepository;
import com.aade.web.security.AuthoritiesConstants;
import com.aade.web.service.MailService;
import com.aade.web.service.UserService;
import com.aade.web.service.dto.UserDTO;
import com.aade.web.web.rest.errors.BadRequestAlertException;
import com.aade.web.web.rest.errors.EmailAlreadyUsedException;
import com.aade.web.web.rest.errors.LoginAlreadyUsedException;
...
public class UserResource {
    ...
    private final RowSearchRepository rowSearchRepository;

    private final JestElasticsearchTemplate elasticsearchTemplate;

    public UserResource(UserService userService, UserRepository userRepository, MailService mailService,
    		UserSearchRepository userSearchRepository, RowSearchRepository rowSearchRepository, JestElasticsearchTemplate elasticsearchTemplate) {

        this.userService = userService;
        this.userRepository = userRepository;
        this.mailService = mailService;
        this.userSearchRepository = userSearchRepository;
        this.rowSearchRepository = rowSearchRepository;
    ...
    @GetMapping("/_search/data/{query}")
    public List<Row> searchData(@PathVariable String query) {
        return StreamSupport
            .stream(rowSearchRepository.search(queryStringQuery(query)).spliterator(), false)
            .collect(Collectors.toList());
    }
